 ...
 */
public class BaoYangJLFragment extends PSFragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public static BaoYangJLFragment newInstance(String id) {
        BaoYangJLFragment fragment = new BaoYangJLFragment();
    ...
    private OkObject getOkObjectClient() {
        String url = Constant.HOST + Constant.Url.Usercar_Maintain_Log;
