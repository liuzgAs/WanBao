...
public class FaQiPTActivity extends BaseActivity {
    ...
    private Orderteam_Index pay_new_pay;
    private int currentItem;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fa_qi_pt);
        ...
        HttpApi.post(context, getOkObjectOrder(), new HttpApi.CallBack() {
            ...
            public void onSuccess(String s) {
                ...
                try {
                    ...
                    pay_new_pay = GsonUtils.parseJSON(s, Orderteam_Index.class);
    ...
    class MyPageAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return FaQiPTFragment.newInstance(pay_new_pay.getType().get(position).getV());
