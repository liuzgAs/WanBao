...
import com.wanbao.viewholder.MOAuthViewHolder;
...
public class QueRenSQActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<MaintainOrdeAuth.DataBean>(QueRenSQActivity.this) {
            @Override
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnSubmit:
                ...
                setState(BaseEvent.IsAuth, String.valueOf(id));
                break;
            default:
                break;
        }
    ...
    private void getAuth() {
        HttpApi.post(context, getOkObjectAuth(), new HttpApi.CallBack() {
            ...
            public void onSuccess(String s) {
                try {
                    LogUtils.e("爱车", s);
                    MaintainOrdeAuth maintainOrdeAuth = GsonUtils.parseJSON(s, MaintainOrdeAuth.class);
