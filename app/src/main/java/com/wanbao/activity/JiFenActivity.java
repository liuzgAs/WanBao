...
import com.wanbao.viewholder.JFViewHolder;
...
public class JiFenActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private RecyclerArrayAdapter<Account_Score.DataBean> adapter;
    private int page = 1;
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Account_Score.DataBean>(JiFenActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_yj;
                return new JFViewHolder(parent, layout);
            }
        });
            ...
            public void onMoreShow() {
                HttpApi.post(context, getOkObjectAmount(), new HttpApi.CallBack() {
                    ...
                    public void onSuccess(String s) {
                        try {
                            page++;
                            Account_Score usercar_index = GsonUtils.parseJSON(s, Account_Score.class);
        ...
        adapter.setOnItemClickListener(new RecyclerArrayAdapter.OnItemClickListener() {
            ...
            public void onItemClick(int position) {
                ...
                intent.setClass(context,JiFenXQActivity.class);
        ...
        HttpApi.post(context, getOkObjectAmount(), new HttpApi.CallBack() {
            ...
            public void onSuccess(String s) {
                try {
                    ...
                    int status = usercar_index.getStatus();
                    if (status == 1) {
                        textAmount.setText(usercar_index.getScore() + "");
                        adapter.clear();
                        adapter.addAll(usercar_index.getData());
                    } else {
                        ToastUtils.showShort(usercar_index.getInfo());
    ...
    private OkObject getOkObjectAmount() {
        String url = Constant.HOST + Constant.Url.Account_Score;
