...
import com.wanbao.viewholder.YjXqViewHolder;
...
public class YongjinXQActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private String id;
    private RecyclerArrayAdapter<Account_Amountinfo.DesBean> adapter;
    private  Account_Amountinfo amountinfo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_yongjin_xq);
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Account_Amountinfo.DesBean>(YongjinXQActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_yjxq;
                return new YjXqViewHolder(parent, layout);
            }
        });
        adapter.addHeader(new RecyclerArrayAdapter.ItemView() {
            ...
            public void onBindView(View headerView) {
                imageXq.setImageDrawable(ContextCompat.getDrawable(context,R.mipmap.icon_yjxq));
                if (amountinfo!=null){
                    textXq.setText(amountinfo.getTitle());
                    textNum.setText(amountinfo.getMoney()+"");
                }
            }
        });
            ...
            public void onSuccess(String s) {
                try {
                    LogUtils.e("Account_Amountinfo", s);
                     amountinfo = GsonUtils.parseJSON(s, Account_Amountinfo.class);
    ...
    private OkObject getOkObjectAmount() {
        String url = Constant.HOST + Constant.Url.Account_Amountinfo;
