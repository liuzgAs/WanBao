...
import com.wanbao.viewholder.HongBaoMXViewHolder;
...
public class HongBaoMXActivity extends BaseActivity implements SwipeRefreshLayout.OnRefreshListener{
    ...
    private RecyclerArrayAdapter<Bonus_Amount.DataBean> adapter;
    private int page = 1;
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Bonus_Amount.DataBean>(HongBaoMXActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_yj;
                return new HongBaoMXViewHolder(parent, layout);
            }
        });
            ...
            public void onMoreShow() {
                HttpApi.post(context, getOkObjectAmount(), new HttpApi.CallBack() {
                    ...
                    public void onSuccess(String s) {
                        try {
                            page++;
                            Bonus_Amount usercar_index = GsonUtils.parseJSON(s, Bonus_Amount.class);
    ...
    private OkObject getOkObjectAmount() {
        String url = Constant.HOST + Constant.Url.Bonus_Amount;
