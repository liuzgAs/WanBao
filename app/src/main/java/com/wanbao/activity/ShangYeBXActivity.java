...
import com.wanbao.viewholder.ShangYeBXHolder;
import com.wanbao.viewholder.ShangYeBXRightHolder;
...
public class ShangYeBXActivity extends BaseActivity {
    ...
    private RecyclerArrayAdapter<Calculator_Index.Des2Bean.SBeanXX> adapter;
    private RecyclerArrayAdapter<Calculator_Index.Des2Bean.SBeanXX.SBeanX> adapterR;
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Calculator_Index.Des2Bean.SBeanXX>(ShangYeBXActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_shangyebx;
                return new ShangYeBXHolder(parent, layout);
            }
        });
    ...
    private void initRecyclerRight() {
        ...
        recyclerViewRight.setAdapterWithProgress(adapterR = new RecyclerArrayAdapter<Calculator_Index.Des2Bean.SBeanXX.SBeanX>(ShangYeBXActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
                int layout = R.layout.item_shangyebx_right;
                return new ShangYeBXRightHolder(parent, layout);
            }
        });
