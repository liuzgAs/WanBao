...
import com.wanbao.fragment.SosJLFragment;
...
public class SosJLActivity extends BaseNoLeftActivity {
    ...
    private Sos_SosLog pay_new_pay;
    private int currentItem;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sos_jl);
    ...
    class MyPageAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return SosJLFragment.newInstance(pay_new_pay.getType().get(position).getV());
        ...
        HttpApi.post(context, getOkObjectOrder(), new HttpApi.CallBack() {
            ...
            public void onSuccess(String s) {
                ...
                try {
                    ...
                    pay_new_pay = GsonUtils.parseJSON(s, Sos_SosLog.class);
