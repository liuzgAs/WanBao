...
public class ShangYeBXDKActivity extends BaseActivity {
    ...
    private void initRecycler() {
        ...
        recyclerView.setAdapterWithProgress(adapter = new RecyclerArrayAdapter<Calculator_Loan.Des2Bean.SBeanXX>(ShangYeBXDKActivity.this) {
            @Override
    ...
    private void initRecyclerRight() {
        ...
        recyclerViewRight.setAdapterWithProgress(adapterR = new RecyclerArrayAdapter<Calculator_Loan.Des2Bean.SBeanXX.SBeanX>(ShangYeBXDKActivity.this) {
            @Override
            public BaseViewHolder OnCreateViewHolder(ViewGroup parent, int viewType) {
