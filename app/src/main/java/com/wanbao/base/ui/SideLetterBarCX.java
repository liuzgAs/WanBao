...
public class SideLetterBarCX extends View {
    ...
    public SideLetterBarCX(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SideLetterBarCX(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SideLetterBarCX(Context context) {
        super(context);
    }
