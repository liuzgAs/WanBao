...
public class EventReminderUtils {
    ...
    private static String CALENDARS_DISPLAY_NAME = "牵车";
     ...
     * @param context
     */
    public static void addCalendarEvent(final Activity context, String data, String description) {
        // 获取日历账户的id
        ...
        event.put("title", description + data);
        event.put("description", description);
        // 插入账户的id
        event.put("calendar_id", calId);
        long start = getDateLong(data);
