...
/**
 * Created by zhangjiebo on 2018/4/9/009.
 *
 * @author ZhangJieBo
 */
...
public class SetTitleColor {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        if (isFlyme()) {
            ...
            activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, 0, 0, SetTitleColor.navigationHeight);
        }
    }
