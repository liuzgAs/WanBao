...
public class ArcProgressBar extends View {
    ...
    private void initView() {
        ...
        int colorStart = getResources().getColor(R.color.light_red);
        int color1 = getResources().getColor(R.color.light_red);
        int colorEnd = getResources().getColor(R.color.deep_red);
...
//        mRonudRectPaint.setColor(mDottedRunColor);
        mRonudRectPaint.setShader(backGradient);
