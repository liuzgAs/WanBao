 ...
 * data：16/7/27
 */
public class GridImage1Adapter extends
        RecyclerView.Adapter<GridImage1Adapter.ViewHolder> {
    ...
    public GridImage1Adapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.gv_filter_image1,
                viewGroup, false);
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index != RecyclerView.NO_POSITION) {
                        ...
                        EventBus.getDefault().post(new BaseEvent(BaseEvent.INDEX,index));
                    }
                }
            });
