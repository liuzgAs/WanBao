...
public class ShangYeBXHolder extends BaseViewHolder<Calculator_Index.Des2Bean.SBeanXX> {
    ...
    public ShangYeBXHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(final Calculator_Index.Des2Bean.SBeanXX data) {
        super.setData(data);
