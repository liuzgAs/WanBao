...
public class TuiJianYJViewHolder extends BaseViewHolder<Money_Amount.DataBean> {
    private final TextView textName;
    private final TextView textCreateTime;
    private final TextView textMoney;

    public TuiJianYJViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(Money_Amount.DataBean data) {
        super.setData(data);
