...
public class WoDeCDViewHolder extends BaseViewHolder<User_Teamlog.DataBean> {
    ...
    public WoDeCDViewHolder(ViewGroup parent, @LayoutRes int res) {
        super(parent, res);
    ...
    @Override
    public void setData(User_Teamlog.DataBean data) {
        super.setData(data);
